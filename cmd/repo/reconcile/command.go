...
default branch instead, "devctl: default branch", with the App, the
repository admins and the owning team as bypass actors for pull requests
unless the entry declares agentMerge: false, and
