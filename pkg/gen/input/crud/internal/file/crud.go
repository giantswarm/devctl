...
func NewCRUDInput() input.Input {
	...
	i := input.Input{
		Path:         internal.RegenerableFilePrefix + "crud.go",
		TemplateBody: crudTemplate,
...
var crudTemplate = `// NOTE this file is copied from operatorkit for migration purposes. The goal
