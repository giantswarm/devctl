...
//go:embed cluster_app_values_validation_using_schema.yaml.template*
var clusterAppValuesValidationUsingSchemaTemplateFiles embed.FS

var clusterAppValuesValidationUsingSchemaTemplateSha = input.TemplateSHA(clusterAppValuesValidationUsingSchemaTemplateFiles, "cluster_app_values_validation_using_schema.yaml.template")
